    ...
    public static async Task EnsureSeededAsync(IServiceProvider sp)
    {
        ...
        if (!db.Services.Any())
        {
            db.Services.AddRange(
                new ServiceItem { Title = "البحث والمقارنة", Description = "نبحث عن الخيارات المناسبة لطلبك، نقارن بينها، ونختصر لك الأفضل لاتخاذ قرارك بسهولة.", Icon = "search", SortOrder = 1 },
                new ServiceItem { Title = "الحضور عنك والتنفيذ", Description = "نحضر للموقع ونتولى تنفيذ المطلوب ومتابعته وتنفيذ كل الإجراءات بالنيابة عنك.", Icon = "pin", SortOrder = 2 },
                new ServiceItem { Title = "الإشراف على التنفيذ", Description = "نتابع تنفيذ مهمتك خطوة بخطوة، ونتأكد من سيرها وفق المطلوب، ونطلعك على المستجدات حتى اكتمالها.", Icon = "clipboard", SortOrder = 3 },
                new ServiceItem { Title = "المراجعة والمتابعة", Description = "نتولى عنك مراجعة الجهات الحكومية والقطاع الخاص، ومتابعة المعاملات والطلبات والإجراءات، والتواصل مع الجهات ذات العلاقة حتى استكمال المطلوب، مع إبقائك على اطلاع بالمستجدات.", Icon = "review", SortOrder = 4 },
                new ServiceItem { Title = "التنسيق والترتيب", Description = "فريق مختص يتولى تنسيق وترتيب متطلباتك من البداية حتى الاكتمال، بما يشمل المواعيد والحجوزات، المناسبات الخاصة والعامة، تنسيق الخدمات ومقدميها، التواصل بين الأطراف، وترتيب التفاصيل والمتطلبات؛ لتكون جميعها منظمة ومتابعة دون أن تشغلك تفاصيلها.", Icon = "calendar", SortOrder = 5 },
                new ServiceItem { Title = "المهام الإلكترونية", Description = "فريق مختص يتولى تنفيذ ومتابعة مختلف المهام والخدمات الإلكترونية عن بُعد، بما يشمل الخدمات الحكومية وخدمات القطاع الخاص، تقديم ومتابعة الطلبات، الحجوزات والمواعيد، البحث، التواصل والتنسيق والإجراءات الرقمية، حتى استكمال المطلوب وفق نطاق الخدمة.", Icon = "laptop", SortOrder = 6 });
        }
